...
namespace CSAssistant.Helpers
{
	internal static class Messaging
	{
		...
		public const string LangsCourseRecieved = "LangsCourseRecieved";
		public const string CochransCourseRecieved = "CochransCourseRecieved";

		public const string LangsCourseChanged = "LangsClassChanged";
